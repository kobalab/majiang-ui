...
module.exports = class Board {
    ...
    constructor(root, pai, audio, model) {
        ...
        this._view  = {
            ...
            he:      [],
            say:     [],
            diaolog: new HuleDialog($('.hule-dialog', root), pai, model),
    ...
    redraw() {
        ...
        this._view.diaolog.hide();
        hide(this._view.summary);
        if (this.no_player_name) hide($('> .player', this._root));
    ...
    pingju(pingju) {
        ...
        this._timeout_id = setTimeout(()=>{
            ...
            this._view.diaolog.pingju(pingju);
        }, duration);
    }
